...
<body>
  ...
  <li ><a href="/talento/web/index.php/curso/index"><span class="glyphicon glyphicon-pencil">Cursos

  </a></li>
  <li><a href="/talento/web/index.php/deporte/index"><span class="glyphicon glyphicon-dashboard">Deportes</a></li>
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
      ...
      <li class="active"><a href="/talento/web/index.php/site/aspirante">Aspirante</a></li>

      <li ><a href="/talento/web/index.php/atleta/index">Atletas</a></li>
      </li>
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
        ...
        <li class="active" ><a href="/talento/web/index.php/antropometrica/index">Antropometricas</a></li>
      <li ><a href="/talento/web/index.php/general/index">Generales</a></li>
      <li ><a href="/talento/web/index.php/especifica/index">Especificas</a></li>
      <li ><a href="/talento/web/index.php/medica/index">Medicas</a></li>
      <li ><a href="/talento/web/index.php/psicologica/index">Psicologicas</a></li>
  ...
  <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
     <span class="glyphicon glyphicon-book"> Planificacion</span> <span class="caret"></span>
    </a>
    <ul class="dropdown-menu" role="menu">
      <li class="active"><a href="/talento/web/index.php/plan/index">Crear Plan</a></li>
      <li ><a href="/talento/web/index.php/macrociclo/index">Macrociclos</a></li>
      <li ><a href="/talento/web/index.php/mesociclo/index">Mesociclos</a></li>  
      <li ><a href="/talento/web/index.php/microciclo/index">Microciclos</a></li> 
      <li ><a href="/talento/web/index.php//sesion/index">Sesiones</a></li> 
      <li ><a href="/talento/web/index.php/contenido/index">Contenido</a></li>        
  ...
  <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
     <span class="glyphicon glyphicon-globe"> Competencias</span> <span class="caret"></span>
    </a>
    <ul class="dropdown-menu" role="menu">
      <li class="active"><a href="/talento/web/index.php/competencia/index">Crear competencias</a></li>
      <li ><a href="/talento/web/index.php/evento/index">Eventos</a></li>
      <li ><a href="/talento/web/index.php/resultado/index">Resultados</a></li>   
  ...
  <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
     <span class="glyphicon glyphicon-user">Empleados</span>   <span class="caret"></span>
    </a>
    <ul class="dropdown-menu" role="menu">
      
      <li class="active"><a href="/talento/web/index.php/persona/entrenador">Crear Entrenador</a></li>
      <li ><a href="/talento/web/index.php/entrenador/index">Gestionar entrenador</a></li>
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
      <li class="active" ><a href="/talento/web/index.php/reportico/">
        Modulo de Gestion de reportes</a></li>
        <li ><a href="/talento/web/index.php/resultado/evolucion">
        Evolucion del atleta</a></li>
