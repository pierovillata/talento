...
<body>
  ...
  <li class="active"><a href="/talento/web/index.php/persona/index">
  ...
  <li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
      <li><a href="/talento/web/index.php/antropometrica/percentil">Calcular Percentiles Antropometricos</a></li>
